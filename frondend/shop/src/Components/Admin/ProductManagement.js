...
function ProductManagement() {
    ...
    const loadDataProductCategory = () => {
        ...
        fetch(`/product-category/auth/admin/${page}/${pageSize}/${field}?title=${title}&status=${status}&category=${category}&sort=${sort}`, requestOptions)
            .then((response) => {
                if (response.ok) {
                                                    ...
                                                    {data.length > 0 ? (
                                                        data.map((item, i) => (
                                                            ...
                                                            >
                                                                ...
                                                                <TableCell className="text-nowrap">{item.product.users.firstName+" "+ item.product.users.lastName}</TableCell>
                                                                <TableCell align="right">{VND.format(item.product.price)}</TableCell>
                                                                <TableCell align="right">{item.product.discount}(%)</TableCell>
                                                                <TableCell align="right">{item.product.quantity}</TableCell>
                                                                <TableCell className="text-nowrap">
                                                                    {format(parseISO(item.product.createdAt), "dd-MM-yyyy")}
                                                                </TableCell>
                                                                <TableCell className="text-nowrap">
                                                                ...
                                                                <TableCell align="center" className="row  ">
                                                                    ...
                                                                    <Link to={`/management/update-product/${item.product.id}`}>
