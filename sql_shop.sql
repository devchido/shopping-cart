...
INSERT INTO `shop`.`product` 
	(`user_id`, `title`, `slug`, `summary`, `price`, `discount`, `quantity`, `photos`, `created_at`, `content`) 
VALUES 
    ('2', 'Áo nữ', 'ao-phong-nu', 'Áo nữ', '200000', '20', '10',
    'https://cf.shopee.vn/file/2a9f3d3a1bd30d41e1bd63d07c7b387f',
    '2023-03-04 00:00:00', 'Áo phông dành cho nữ');
INSERT INTO `shop`.`product` 
	(`user_id`, `title`, `slug`, `summary`, `price`, `discount`, `quantity`, `photos`, `created_at`, `content`) 
VALUES 
    ('1', 'Mũ lưỡi trai', 'mu-luoi-trai', 'Mũ lưỡi trai', '100000', '0', '10',
    'https://phuocthinhcorp.com/wp-content/uploads/2021/12/mu-luoi-trai-nu-800x800.jpg',
    '2023-03-05 00:00:00', 'Mũ Lưỡi trai');
INSERT INTO `shop`.`product` 
	(`user_id`, `title`, `slug`, `summary`, `price`, `discount`, `quantity`, `photos`, `created_at`, `content`) 
VALUES 
    ('2', 'Quần LEGGING', 'quan-legging', 'Quần-LEGGING', '100000', '30', '100',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0Qu5dvSEKNQZWY6wD04-az7mufu4UdCqOLA&usqp=CAU',
    '2023-03-05 00:00:00', 'Quần-LEGGING');
INSERT INTO `shop`.`product` 
	(`user_id`, `title`, `slug`, `summary`, `price`, `discount`, `quantity`, `photos`, `created_at`, `content`) 
VALUES 
    ('1', 'Giày Nike Air Max 97 DM0027-001 Nam', 'giay-lifestyle-nam-nike-air-max-97-dm0027-001', 'Giày nam', '5279000', '0', '150',
    'https://sneakerdaily.vn/wp-content/uploads/2022/10/giay-nike-air-max-97-panda-dm0027-001.png.webp',
    '2023-03-05 00:00:00', 'Giày Nike Air Max 97 DM0027-001 được thiết kế với chất liệu 28% Synthetic, 28% Textile và 44% Leather đáp ứng tốt và đảm bảo được các tiêu chí mềm, bền, mịn và đẹp');
INSERT INTO `shop`.`product` 
	(`user_id`, `title`, `slug`, `summary`, `price`, `discount`, `quantity`, `photos`, `created_at`, `content`) 
VALUES 
    ('2', 'Ví Card Feasty', 'vi-card-feasty', 'Ví Card Feasty', '260.000', '20', '150',
    'https://cdn.shopify.com/s/files/1/1236/1344/products/vi-card-feasty-xanh-reu-wallet-leonardo-24673225474223_600x.png?v=1622167999',
    '2023-03-05 13:20:00', 'Một chiếc ví card cánh gập cơ bản, tối giản nhất, mọi chi tiết thêm vào là sự thừa thãi không cần thiết.');
